...
\newcommand{\pdfTitle}{Stanisław Nieradko's CV}
\newcommand{\pdfAuthor}{Stanisław Nieradko}
\setupPDF
...
\github{https://git.nieradko.com/}
\email{stanislaw@nieradko.com}{mailto:stanislaw@nieradko.com}
\phone{+48 506 257 727}{tel:+48506257727}

\begin{minipage}[t]{.68\textwidth}
    \section{Projects}

    \project{SSGP}{C\#, ASP.Net Core}{2022}{https://git.nieradko.com/SSGP/}{
    ...
    \project{eru}{C\#, ASP.Net Core}{2020}{https://git.nieradko.com/eru/}{
    ...
    \project{JedzenioPlanner}{C\#, ASP.Net Core}{2020}{https://git.nieradko.com/JedzenioPlanner/}{
    ...
    \project{WokLearner}{C\#, ASP.Net Core}{2020}{https://git.nieradko.com/WokLearner/}{
    ...
    \project{SuperGamblino}{C\#, DSharpPlus}{2020}{https://git.nieradko.com/SuperGamblino/}{
    ...
    \school{XX Liceum Ogólnokształcące im. Zbigniewa Herberta}{2019-2022}{Gdańsk, Poland}
